...
hook OnGameModeInit()
{
	...
	LOGINTD[1] = TextDrawCreate(371.000000, 121.000000, "LEGANES NEW ERA");
	...
	LOGINTD[2] = TextDrawCreate(421.000000, 295.000000, "Version 1.1a Native");
	...
	LOGINTD[3] = TextDrawCreate(352.000000, 137.000000, "ROLEPLAY");
	...
	LOGINTD[4] = TextDrawCreate(371.000000, 121.000000, "LEGANES NEW ERA");
